...
function conf_form(){
  ...
  $conf=fopen("conf_spen.html","r") or die;
  $size=filesize("conf_spen.html");
...
#テンプレート読み込み
  ...
  $conf=fopen("done_spen.html","r") or die;
  $size=filesize("done_spen.html");
  $data=fread($conf,$size);
  fclose($conf);
...
#  $mailFrom="send-mail@tgn-soleil.com";
#  $mailFrom=str_replace(array("\r\n", "\r"), "",$mailFrom);

##  $name="From:".mb_encode_mimeheader($name);
#  $mailFrom="TGNsoleil"."hello@tgn-soleil.com";
