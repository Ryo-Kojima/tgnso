...
if(sei.value=="" || mei.value==""){
  ...
  (tel.value==""){
  var tatemono = document.getElementById( "tatemonomei" ) ;
...
if(email.value=="" || email2.value==""){
  ...
  var positionX = telrect.left + window.pageXOffset ;	
  var positionY = telrect.top + window.pageYOffset ;	// 要素のY座標
  window.scrollTo( positionX, positionY ) ;
...
if(email.value !== email2.value){
  ...
  var telrect = tell.getBoundingClientRect() ;
  var positionX = telrect.left + window.pageXOffset ;	
  var positionY = telrect.top + window.pageYOffset ;	// 要素のY座標
  window.scrollTo( positionX, positionY ) ;
